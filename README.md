...
-      During SQL import, duplicate order IDs were detected. Further validation showed conflicting city values for the same order_id,
 ...
 ##✍ Markdown
- [x] 📊 Dataset & Insights
     Final cleaned dataset contains 18,957 rows and 9 columns. SQL analysis was performed to calculate revenue, orders, AOV, city-wise  performance, and peak shopping hours.
